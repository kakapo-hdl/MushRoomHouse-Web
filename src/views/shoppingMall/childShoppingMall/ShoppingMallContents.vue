...
<script>
import ThameMarket from '../../../components/common/thameMarket/ThameMarket.vue';
import ShoppingGirlMsg from '../../../components/content/shoppingMall/ShoppingGirlMsg.vue';
import ShoppingHallMsg from '../../../components/content/shoppingMall/ShoppingHallMsg.vue';
import ShoppingPakegetMsg from '../../../components/content/shoppingMall/ShoppingPakegetMsg.vue';
...
.shopping-mall-herder div {
  overflow: hidden;
}
.shopping-mall-herder div:nth-of-type(1) {
  width: 305px;
  height: 100%;
  position: relative;
  overflow: hidden;
  ...
  background: url("../../../assets/image/shoppingmall/shoppingmallheader.png");
  background-size: 95% 100%;
}
.shopping-mall-herder div:nth-of-type(1) a {
  position: absolute;
  left: 50px;
  cursor: pointer;
  font-size: 18px;
...
.shopping-mall-herder div:nth-of-type(2) a {
  display: block;
  text-align: center;
  height: 40px;
  line-height: 40px;
...
.shopping-mall-herder div:nth-of-type(2) a:hover {
  cursor: pointer;
